...
/* Define to 1 if hiredis is enabled */
/* #undef HAVE_HIREDIS */

/* Define to 1 if iconv.h is present */
...
/* Define to 1 if memcached is enabled */
...
/* Define to 1 if rl_attempted_completion_over is defined */
...
/* Define to 1 if rl_completion_matches is defined */
...
/* Define to 1 if tcp wrap library is present */
/* #undef HAVE_TCPD_H */
...
#define PACKAGE_STRING "yaz 5.4.1"
...
/* Define to 1 if EXSLT is present */
/* #undef YAZ_HAVE_EXSLT */

/* Define to 1 if Libxml2 is present */
#define YAZ_HAVE_XML2 1

/* Define to 1 if Libxslt is present */
#define YAZ_HAVE_XSLT 1

/* Define to 1 if POSIX threads is present */
